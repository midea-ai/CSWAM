...
def load_wan22_text_components(
    ...
    """Load only the Wan text encoder and tokenizer.

    Models without a Wan video expert should not instantiate the 5B video DiT
    or VAE just to obtain text conditioning.
    """
